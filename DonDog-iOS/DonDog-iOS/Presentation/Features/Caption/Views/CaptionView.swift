            ...
            VStack(spacing: 20) {
                ...
                .padding(20)
                    if let frontImage = viewModel.frontImage, let backImage = viewModel.backImage {
                        HStack{
                            Spacer()
                            PolaroidSetView(frontImage: frontImage, backImage: backImage, nickname: "", createdAt: "", caption: nil, onStickerButtonTapped: {}, selectedStickerEmotion: nil, stickerImage: nil, isMyPost: true)
