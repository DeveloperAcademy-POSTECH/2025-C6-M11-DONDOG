...
struct UserData: Codable {
    ...
    let lastUploadedAt: Timestamp?
    let createdAt: Timestamp?
    let updatedAt: Timestamp?

    init(name: String, role: String, roomId: String? = nil, recentPostId: String? = nil, lastUploadedAt: Timestamp? = nil, createdAt: Timestamp? = nil, updatedAt: Timestamp? = nil) {
        self.name = name
        self.role = role
        self.roomId = roomId
